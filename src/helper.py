...
def define_save_path(file_name: str, filename: str) -> str:
        return os.path.join(os.path.dirname(__file__), '..', file_name, f'game_data_{filename}.json')
...
def save_game_data(game: game_data, game_id: dict) -> None:
    """
